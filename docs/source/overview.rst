...
To install the casacore-table backend (based on
`arcae <https://github.com/ska-sa/arcae>`__) along with the zarr backend,
which enables conversion from MSv2 to MSv4 and CASA image IO on both Linux
and macOS, use:

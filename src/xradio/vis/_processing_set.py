...
class processing_set(dict):
    ...
    def summary(self,data_group='base'):
        ...
        for key, value in self.items():
            ...
            summary_data["field_id"].append(value[value.attrs["data_groups"][data_group]['visibility']].attrs["field_info"]["field_id"])
            summary_data["field_name"].append(value[value.attrs["data_groups"][data_group]['visibility']].attrs["field_info"]["name"])

...
def test_subtables_read_ms_subtables_required(ms_empty_required):
    from xradio.correlated_data._utils._ms.subtables import read_ms_subtables
...
def test_subtables_pointing_to_partition():
    from xradio.correlated_data._utils._ms.subtables import add_pointing_to_partition
    import xarray

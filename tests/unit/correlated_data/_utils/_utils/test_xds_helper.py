...
def test_partitions_make_coords():
    from xradio.correlated_data._utils._utils.xds_helper import make_coords
...
def test_xds_packager_cds(ant_xds_min):
    from xradio.correlated_data._utils._utils.xds_helper import vis_xds_packager_cds
...
def test_make_global_coords_none():
    from xradio.correlated_data._utils._utils.xds_helper import make_global_coords
...
def test_expand_xds_empty():
    from xradio.correlated_data._utils._utils.xds_helper import expand_xds
...
def test_flatten_xds_empty():
    from xradio.correlated_data._utils._utils.xds_helper import flatten_xds
...
def test_optimal_chunking(ndim, didxs, chunk_size, data_shape, expected_res):
    from xradio.correlated_data._utils._utils.xds_helper import optimal_chunking

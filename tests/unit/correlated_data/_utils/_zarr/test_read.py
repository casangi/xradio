...
def test_read_part_keys(ms_as_zarr_min):
    from xradio.correlated_data._utils._zarr.read import read_part_keys
...
def test_read_subtables(ms_as_zarr_min):
    from xradio.correlated_data._utils._zarr.read import read_subtables
...
def teest_read_paritions(ms_as_zarr_min):
    from xradio.correlated_data._utils._zarr.read import read_partitions
...
def test_read_xds(ms_as_zarr_min):
    from xradio.correlated_data._utils._zarr.read import read_xds
...
def test_read_zarr(ms_as_zarr_min):
    from xradio.correlated_data._utils._zarr.read import read_zarr
...
def test__fix_dict_for_ms(main_xds_min):
    from xradio.correlated_data._utils._zarr.read import _fix_dict_for_ms
    import copy

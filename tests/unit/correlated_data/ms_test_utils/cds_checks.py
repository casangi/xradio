...
def check_cds(
    ...
    check_cor_metainfo(vis, partition_scheme, descr, subtables)
    check_cor_partitions(vis, partition_scheme, descr, chunks)


def check_cor_metainfo(
    vis: CASAVisSet,
...
def check_cor_partitions(vis, partition_scheme, descr, chunks):
    ...
    if not chunks:
        check_cor_partitions_read(vis, partition_scheme, descr, chunks)
    else:
        check_cor_partitions_load(vis, partition_scheme, descr, chunks)


def check_cor_partitions_read(vis, partition_scheme, descr, chunks):
...
def check_cor_partitions_load(vis, partition_scheme, descr, chunks):

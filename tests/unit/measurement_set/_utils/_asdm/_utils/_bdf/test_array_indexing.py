...
@pytest.mark.parametrize(
    ...
    [
        ...
        (time_indices_by_bdf_simple_3, slice(None, 1), ["a"], [slice(0, 1)]),
        ...
        (time_indices_by_bdf_simple_3, slice(19, None), ["c"], [slice(4, 10)]),
        ...
        (
            ...
            slice(2, 23),
            ["a", "b", "c"],
            [slice(2, 10), slice(0, 5), slice(0, 8)],
        ),
        (
            time_indices_by_bdf_simple_3,
            slice(None, 25),

...
def test_make_spw_names_by_ddi():
    from xradio.measurement_set._utils._msv2.partitions import make_spw_names_by_ddi
    import xarray
...
def test_split_intents(intents, expected_results):
    from xradio.measurement_set._utils._msv2.partitions import split_intents
...
def test_make_part_key():
    from xradio.measurement_set._utils._msv2.partitions import make_part_key
    import xarray
